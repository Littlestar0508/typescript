...
// 단, 직접 score 프로퍼티 값을 수정할 수는 없습니다. -> Getter만 수행
...

{
  ...
  class Player {
    constructor(private nickname: string, private role: string, private _score: number = 0) {
      this.boostScoreUp();
    }
  ...
  // WRITE
  // yamoo9.score = 50; -> 불가능 (SETTER 생기면 가능)

  console.log(yamoo9.fullName);

  yamoo9.fullName = "instructor yamoo9";
  yamoo9.fullName = { role: "educator", nickname: "yamoo9" };
}
