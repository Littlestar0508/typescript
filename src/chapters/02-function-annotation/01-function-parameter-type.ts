...

{
  ...
  console.log(getRandomMinMax(10_000, 100_000));
}
...

{
  ...
  sendGreeting("littlestar", "hey", false, new Date().getFullYear());

  console.log(sendGreeting("littlestar", "hey", false, new Date().getFullYear()));
}
